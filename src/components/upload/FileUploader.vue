<template>
  <div id="global-uploader">
    ...
    >
      ...
      <!-- 选择文件夹按钮 -->
      <uploader-btn class="select-file-btn" :attrs="attrs" ref="uploadBtn" :directory="true">选择文件夹</uploader-btn>
      <!-- 正在上传的文件面板 -->
...
import { getMultipartUpload, getUpFile } from "@/api/hospital/patient/file";
import { analysisFile } from "@/api/hospital/patient/patient";
...
export default {
  ...
  created() {
    // if (this.fileTypeValue === undefined) {
